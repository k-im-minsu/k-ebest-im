...
/**
 * @typedef {Object} t8417 [업종] 시세 - 업종차트_틱_n틱
 * @property {string} rsp_cd tr 코드
 * @property {string} rsp_msg tr 메세지
 * @property {t8417_OutBlock} t8417OutBlock
 * @property {Array<t8417_OutBlock1>} t8417OutBlock1
 */
/**
 * @typedef {Object} t8417_OutBlock [업종] 시세 - 업종차트_틱_n틱 
 ...
 */
/**
 * @typedef {Object} t8417_OutBlock1 [업종] 시세 - 업종차트_틱_n틱 
 ...
 * @returns {Promise<t8417|null>}  실패시 null 반환
 */
 exports.업종차트_틱_n틱 = async(shcode="",ncnt=0,qrycnt=0,nday="",sdate="",stime="",edate="",etime="",cts_date="",cts_time="",comp_yn="",tr_cont="N",tr_cont_key="",mac_address="")=>{
    const header={
