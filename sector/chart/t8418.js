...
/**
 * @typedef {Object} t8418 [업종] 시세 - 업종챠트_N분
 * @property {string} rsp_cd tr 코드
 * @property {string} rsp_msg tr 메세지
 * @property {t8418_OutBlock} t8418OutBlock
 * @property {Array<t8418_OutBlock1>} t8418OutBlock1
 */
/**
 * @typedef {Object} t8418_OutBlock [업종] 시세 - 업종챠트_N분 
 ...
 * @property {string} s_time 업종시작시간(HHMMSS)(6)
 * @property {string} e_time 업종종료시간(HHMMSS)(6)
 * @property {string} dshmin 동시호가처리시간(MM:분)(2)
 * @property {number} rec_count 레코드카운트(7)
 */
/**
 * @typedef {Object} t8418_OutBlock1 [업종] 시세 - 업종챠트_N분 
 ...
 * @param {string} cts_time 연속시간(10) - 
 * @param {string} comp_yn 압축여부(Y:압축N:비압축)(1) - N:비압축 모듈 Y: 압 축 모듈
 * @param {string} tr_cont 연속 거래 여부 [Y,N]
 * @param {string} tr_cont_key 연속일 경우 그전에 내려온 연속키 값 올림
 * @param {string} mac_address 	법인인 경우 필수 세팅
 * @returns {Promise<t8418|null>}  실패시 null 반환
 */
 exports.업종챠트_N분 = async(shcode="",ncnt=0,qrycnt=0,nday="",sdate="",stime="",edate="",etime="",cts_date="",cts_time="",comp_yn="",tr_cont="N",tr_cont_key="",mac_address="")=>{
    const header={
