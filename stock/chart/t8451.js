...
/**
 * @typedef {Object} t8451 [주식] 차트 - API전용주식챠트_일주월년
 * @property {string} rsp_cd tr 코드
 * @property {string} rsp_msg tr 메세지
 * @property {t8451_OutBlock} t8451OutBlock
 * @property {Array<t8451_OutBlock1>} t8451OutBlock1
 */
/**
 * @typedef {Object} t8451_OutBlock [주식] 차트 - API전용주식챠트_일주월년 
 ...
 */
/**
 * @typedef {Object} t8451_OutBlock1 [주식] 차트 - API전용주식챠트_일주월년 
 ...
 * @returns {Promise<t8451|null>}  실패시 null 반환
 */
module.exports = async(shcode="",gubun="",qrycnt=0,sdate="",edate="",cts_date="",comp_yn="",sujung="",exchgubun="K",tr_cont="N",tr_cont_key="",mac_address="")=>{
    const header={
