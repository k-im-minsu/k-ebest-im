...
/**
 * @typedef {Object} t8452 [주식] 차트 - 주식챠트_N분
 * @property {string} rsp_cd tr 코드
 * @property {string} rsp_msg tr 메세지
 * @property {t8452_OutBlock} t8452OutBlock
 * @property {Array<t8452_OutBlock1>} t8452OutBlock1
 */
/**
 * @typedef {Object} t8452_OutBlock [주식] 차트 - 주식챠트_N분 
 ...
 */
/**
 * @typedef {Object} t8452_OutBlock1 [주식] 차트 - 주식챠트_N분 
 ...
 * @property {string} sign 종가등락구분(1:상한2:상승3:보합4:하한5:하락)(1)
 */
/**
 * [주식] 차트 - 주식챠트_N분 (초당 1건 제한)
 * @param {string} shcode 단축코드(6) - 
 * @param {number} ncnt 단위(n분)(4) - 
 ...
 * @returns {Promise<t8452|null>}  실패시 null 반환
 */
module.exports = async(shcode="",ncnt=0,qrycnt=0,nday="",sdate="",stime="",edate="",etime="",cts_date="",cts_time="",comp_yn="",exchgubun="K",tr_cont="N",tr_cont_key="",mac_address="")=>{
    const header={
