...
/**
 * @typedef {Object} t8412 [주식] 차트 - 주식챠트_N분
 * @property {string} rsp_cd tr 코드
 * @property {string} rsp_msg tr 메세지
 * @property {t8412_OutBlock} t8412OutBlock
 * @property {Array<t8412_OutBlock1>} t8412OutBlock1
 */
/**
 * @typedef {Object} t8412_OutBlock [주식] 차트 - 주식챠트_N분 
 ...
 */
/**
 * @typedef {Object} t8412_OutBlock1 [주식] 차트 - 주식챠트_N분 
 ...
 * @returns {Promise<t8412|null>}  실패시 null 반환
 */
 exports.주식챠트_N분 = async(shcode="",ncnt=0,qrycnt=0,nday="",sdate="",stime="",edate="",etime="",cts_date="",cts_time="",comp_yn="",tr_cont="N",tr_cont_key="",mac_address="")=>{
    const header={
