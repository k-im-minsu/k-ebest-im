...
/**
 * @typedef {Object} t1960 [주식] ELW - ELW등락율상위
 * @property {string} rsp_cd tr 코드
 * @property {string} rsp_msg tr 메세지
 * @property {t1960_OutBlock} t1960OutBlock
 * @property {Array<t1960_OutBlock1>} t1960OutBlock1
 */
/**
 * @typedef {Object} t1960_OutBlock [주식] ELW - ELW등락율상위 
 * @property {number} idx IDX(4)
 */
/**
 * @typedef {Object} t1960_OutBlock1 [주식] ELW - ELW등락율상위 
 ...
 * @property {string} itemsign 기초자산대비구분(1)
 * @property {string} itemchange 기초자산전일대비(10)
 * @property {number} itemdiff 기초자산등락율(6.2)
 * @property {string} elwshcode ELW종목코드(6)
 * @property {number} bepoint 손익분기점(12.2)
 */
/**
 * [주식] ELW - ELW등락율상위 (초당 2건 제한)
 * @param {string} gubun 상승하락(0:상승1:하락)(1) - 0:상승율 1:하락율
 * @param {string} ggubun 권리유형구분(00:EX01:콜02:풋'':전체)(2) - #콜/풋/EX 01#콜 02#풋 00#EX
 * @param {string} itemcode 기초자산종목(12) - 기초자산 종목코드 - 스페이스:전체 - basket:BASKET 기초자산 종목 - 종목코드(12자리 표준코드)
 * @param {string} lastdate 조회만기일(8) - YYYYMM 스페이스:전체
 ...
 * @returns {Promise<t1960|null>}  실패시 null 반환
 */
 exports.ELW등락율상위 = async(gubun="",ggubun="",itemcode="",lastdate="",exgubun="",sprice=0,eprice=0,volume=0,sjanday=0,ejanday=0,idx=0,tr_cont="N",tr_cont_key="",mac_address="")=>{
    const header={
