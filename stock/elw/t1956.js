...
/**
 * @typedef {Object} t1956 [주식] ELW - ELW현재가_확정지급액조회
 * @property {string} rsp_cd tr 코드
 * @property {string} rsp_msg tr 메세지
 * @property {t1956_OutBlock} t1956OutBlock
 * @property {Array<t1956_OutBlock1>} t1956OutBlock1
 */
/**
 * @typedef {Object} t1956_OutBlock [주식] ELW - ELW현재가_확정지급액조회 
 ...
 * @property {number} givemoney 확정지급액(8.3)
 */
/**
 * @typedef {Object} t1956_OutBlock1 [주식] ELW - ELW현재가_확정지급액조회 
 ...
 */
/**
 * [주식] ELW - ELW현재가_확정지급액조회 (초당 3건 제한)
 * @param {string} shcode 단축코드(6) - 
 * @param {string} tr_cont 연속 거래 여부 [Y,N]
 * @param {string} tr_cont_key 연속일 경우 그전에 내려온 연속키 값 올림
 * @param {string} mac_address 	법인인 경우 필수 세팅
 * @returns {Promise<t1956|null>}  실패시 null 반환
 */
 exports.ELW현재가_확정지급액조회 = async(shcode="",tr_cont="N",tr_cont_key="",mac_address="")=>{
    const header={
