...
/**
 * @typedef {Object} t1961 [주식] ELW - ELW거래량상위
 * @property {string} rsp_cd tr 코드
 * @property {string} rsp_msg tr 메세지
 * @property {t1961_OutBlock} t1961OutBlock
 * @property {Array<t1961_OutBlock1>} t1961OutBlock1
 */
/**
 * @typedef {Object} t1961_OutBlock [주식] ELW - ELW거래량상위 
 * @property {number} idx IDX(4) - 연속조회키 연속 조회시 이 값을 InBlock의 idx 필드에 넣어준다.
 */
/**
 * @typedef {Object} t1961_OutBlock1 [주식] ELW - ELW거래량상위 
 ...
 * @returns {Promise<t1961|null>}  실패시 null 반환
 */
 exports.ELW거래량상위 = async(gubun="",ggubun="",itemcode="",lastdate="",exgubun="",sprice=0,eprice=0,volume=0,sjanday=0,ejanday=0,idx=0,tr_cont="N",tr_cont_key="",mac_address="")=>{
    const header={
