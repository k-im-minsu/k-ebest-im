...
/**
 * @typedef {Object} t1906 [주식] ETF - ETFLP호가
 * @property {string} rsp_cd tr 코드
 * @property {string} rsp_msg tr 메세지
 * @property {t1906_OutBlock} t1906OutBlock
 */
/**
 * @typedef {Object} t1906_OutBlock [주식] ETF - ETFLP호가 
 ...
 * @returns {Promise<t1906|null>}  실패시 null 반환
 */
 exports.ETFLP호가 = async(shcode="",tr_cont="N",tr_cont_key="",mac_address="")=>{
    const header={
