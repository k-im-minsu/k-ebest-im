/**
 * @typedef {Object} KM_ [주식] 실시간 시세 - KOSDAQ프로그램매매전체집계
 * @property {string} time 수신시간(6)
 * @property {string} cdhrem 차익매도호가 잔량(6)
 * @property {string} cshrem 차익매수호가 잔량(6)
 * @property {string} bdhrem 비차익매도호가 잔량(6)
 * @property {string} bshrem 비차익매수호가 잔량(6)
 * @property {string} cdhvolume 차익매도호가 수량(6)
 * @property {string} cshvolume 차익매수호가 수량(6)
 * @property {string} bdhvolume 비차익매도호가 수량(6)
 * @property {string} bshvolume 비차익매수호가 수량(6)
 ...
 * @property {string} cwvol 차익위탁순매수 수량(6)
 * @property {string} cjvol 차익자기순매수 수량(6)
 ...
 * @property {string} cwval 차익위탁순매수 금액(8)
 * @property {string} cjval 차익자기순매수 금액(8)
