...
/**
 * @typedef {Object} t1101 [주식] 시세 - 주식현재가호가조회
 * @property {string} rsp_cd tr 코드
 * @property {string} rsp_msg tr 메세지
 * @property {t1101_OutBlock} t1101OutBlock
 */
/**
 * @typedef {Object} t1101_OutBlock [주식] 시세 - 주식현재가호가조회 
 ...
 */
/**
 * [주식] 시세 - 주식현재가호가조회 (초당 3건 제한)
 * @param {string} shcode 단축코드(6) - 
 * @param {string} tr_cont 연속 거래 여부 [Y,N]
 * @param {string} tr_cont_key 연속일 경우 그전에 내려온 연속키 값 올림
 * @param {string} mac_address 	법인인 경우 필수 세팅
 * @returns {Promise<t1101|null>}  실패시 null 반환
 */
 exports.주식현재가호가조회 = async(shcode="",tr_cont="N",tr_cont_key="",mac_address="")=>{
    const header={
