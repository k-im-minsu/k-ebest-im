 ...
 * @property {string} nxt_janginfo NXT장구분(10)
 * @property {string} nxt_shterm_text NXT단기과열/VI발동(10)
 * @property {string} nxt_svi_uplmtprice NXT정적VI상한가(8)
 * @property {string} nxt_svi_dnlmtprice NXT정적VI하한가(8)
