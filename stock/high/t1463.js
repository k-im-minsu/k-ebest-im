...
/**
 * @typedef {Object} t1463 [주식] 상위종목 - 거래대금상위
 * @property {string} rsp_cd tr 코드
 * @property {string} rsp_msg tr 메세지
 * @property {t1463_OutBlock} t1463OutBlock
 * @property {Array<t1463_OutBlock1>} t1463OutBlock1
 */
/**
 * @typedef {Object} t1463_OutBlock [주식] 상위종목 - 거래대금상위 
 * @property {number} idx IDX(4)
 */
/**
 * @typedef {Object} t1463_OutBlock1 [주식] 상위종목 - 거래대금상위 
 ...
 */
 exports.거래대금상위 = async(gubun="",jnilgubun="",jc_num=0,sprice=0,eprice=0,volume=0,idx=0,jc_num2=0,tr_cont="N",tr_cont_key="",mac_address="")=>{
    const header={
