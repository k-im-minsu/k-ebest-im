...
/**
 * @typedef {Object} CSPAT00801 [주식] 주문 - 현물취소주문
 * @property {string} rsp_cd tr 코드
 * @property {string} rsp_msg tr 메세지
 * @property {CSPAT00801_OutBlock1} CSPAT00801OutBlock1
 * @property {CSPAT00801_OutBlock2} CSPAT00801OutBlock2
 */
/**
 * @typedef {Object} CSPAT00801_OutBlock1 [주식] 주문 - 현물취소주문 
 ...
 */
/**
 * @typedef {Object} CSPAT00801_OutBlock2 [주식] 주문 - 현물취소주문 
 * @property {number} RecCnt 레코드갯수(5)
 ...
 * @returns {Promise<CSPAT00801|null>}  실패시 null 반환
 */
 exports.현물취소주문 = async(OrgOrdNo=0,IsuNo="",OrdQty=0,tr_cont="N",tr_cont_key="",mac_address="")=>{
    const header={
