...
/**
 * @typedef {Object} t0151 [주식] 계좌 - 주식당일매매일지_수수료_전일
 * @property {string} rsp_cd tr 코드
 * @property {string} rsp_msg tr 메세지
 * @property {t0151_OutBlock} t0151OutBlock
 * @property {Array<t0151_OutBlock1>} t0151OutBlock1
 */
/**
 * @typedef {Object} t0151_OutBlock [주식] 계좌 - 주식당일매매일지_수수료_전일 
 ...
 */
/**
 * @typedef {Object} t0151_OutBlock1 [주식] 계좌 - 주식당일매매일지_수수료_전일 
 ...
 */
/**
 * [주식] 계좌 - 주식당일매매일지_수수료_전일 (초당 2건 제한)
 * @param {string} date 일자(8) - 
 ...
 * @returns {Promise<t0151|null>}  실패시 null 반환
 */
 exports.주식당일매매일지_수수료_전일 = async(date="",cts_medosu="",cts_expcode="",cts_price="",cts_middiv="",tr_cont="N",tr_cont_key="",mac_address="")=>{
    const header={
